...
public class RollingNumber {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RollingNumber.class);
    ...
    private RollingNumber(Time time, int timeInMilliseconds, int numberOfBuckets) {
        this.time = time;
    ...
    /**
     * Increment the counter in the current bucket by one for the given {@link RollingNumberEvent} type.
     * <p>
     * The {@link RollingNumberEvent} must be a "counter" type <code>RollingNumberEvent.isCounter() == true</code>.
     *
     * @param type
     *            RollingNumberEvent defining which counter to increment
     */
    ...
    /**
     * Add to the counter in the current bucket for the given {@link RollingNumberEvent} type.
     * <p>
     * The {@link RollingNumberEvent} must be a "counter" type <code>RollingNumberEvent.isCounter() == true</code>.
     *
     * @param type
     *            RollingNumberEvent defining which counter to add to
     * @param value
     ...
     * <p>
     * The {@link RollingNumberEvent} must be a "max updater" type <code>RollingNumberEvent.isMaxUpdater() == true</code>.
     *
    ...
    /**
     * Get the sum of all buckets in the rolling counter for the given {@link RollingNumberEvent} type.
     * <p>
     * The {@link RollingNumberEvent} must be a "counter" type <code>RollingNumberEvent.isCounter() == true</code>.
     *
     * @param type
     *            RollingNumberEvent defining which counter to retrieve values from
     * @return
     *         value from the given {@link RollingNumberEvent} counter type
     */
    ...
    /**
     * Get the value of the latest (current) bucket in the rolling counter for the given {@link RollingNumberEvent} type.
     * <p>
     * The {@link RollingNumberEvent} must be a "counter" type <code>RollingNumberEvent.isCounter() == true</code>.
     *
     * @param type
     *            RollingNumberEvent defining which counter to retrieve value from
     * @return
     *         value from latest bucket for given {@link RollingNumberEvent} counter type
     */
    ...
    /**
     * Get an array of values for all buckets in the rolling counter for the given {@link RollingNumberEvent} type.
     * <p>
     ...
     * @param type
     *            RollingNumberEvent defining which counter to retrieve values from
     * @return array of values from each of the rolling buckets for given {@link RollingNumberEvent} counter type
     */
    ...
    /**
     * Get the max value of values in all buckets for the given {@link RollingNumberEvent} type.
     * <p>
     * The {@link RollingNumberEvent} must be a "max updater" type <code>RollingNumberEvent.isMaxUpdater() == true</code>.
     *
     * @param type
     *            RollingNumberEvent defining which "max updater" to retrieve values from
     * @return max value for given {@link RollingNumberEvent} type during rolling window
     */
